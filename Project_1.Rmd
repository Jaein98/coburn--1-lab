...
Empirical model works well and needs no special equipment beyond wristwatch. This is common theme, especially when the prediction concerns a more complex, or less well understood, phenomenon.

Bias variance trade off is a property of predictive models in supervised learning. 
...
```
hwy is indiciated on the x value, and count is naturally indiciated on y value.
